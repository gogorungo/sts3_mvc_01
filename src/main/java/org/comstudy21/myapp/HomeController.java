...
public class HomeController {
	...
	public String profile(Model model) {
		model.addAttribute("user_name","김범준");
		model.addAttribute("saram_dto", new SaramDto("KIM","김범준","comstudy21@naver.com"));
		return "profile";
	}
	...
	public String list(Model model) {
		...
		saramList.add(new SaramDto("KIM","김범준","comstudy21@naver.com"));
